![Screenshot](https://i.imgur.com/t7w2Pbn.png?raw=true)
# TP Scripts [Team Progression Scripts]

> [Support Discord](https://discord.gg/DRtfDUdj2T) 
...
- QBCore.Functions.Progressbar(**name**: string, **label**: string, **duration**: number, **useWhileDead**: boolean, **canCancel**: boolean, **disableControls**: table, **animation**: table, **prop**: table, **propTwo**: table, **onFinish**: function, **onCancel**: function)
  ...
  > **Example:**
  > ```lua
  >QBCore.Functions.Progressbar("random_task","Put Text But Not Needed", 5000, false, true, {
